...
This project is indexed by GitNexus as **open-sector** (2788 symbols, 9877 relationships, 234 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
