...
This project is indexed by GitNexus as **open-sector** (2286 symbols, 8128 relationships, 194 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
