...
This project is indexed by GitNexus as **open-sector** (2085 symbols, 7569 relationships, 169 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
