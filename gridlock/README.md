...
Menu, lobby, then a match: deploy the **Rig** into a **Core**, build **Dynamo / Smelter / Muster / Armory**, harvest **scrap** with **Maulers**, train **Troopers** and **Tigers**, and fight (halt-to-fire). Radar lives in the right command bar.
...
Troopers take buildings instead of shooting them: order an attack, stand next to the structure, and hold until the capture bar fills. Drive them off to stop it. Captured buildings change owner. Tigers still shell structures.
